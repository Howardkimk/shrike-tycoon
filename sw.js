const CACHE='shrike-tycoon-0.5.2.1-web';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/cover.png','./assets/icon-192.png','./assets/icon-512.png'];
