...
nextStageButton.onclick = () => { if (stage.id >= 20)
    return; const next = (stage.id + 1); if (save.unlockedStage < next)
    return; selectedStage = next; selectedWorld = next > 10 ? 2 : 1; startGame(); };
