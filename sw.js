const CACHE='shrike-tycoon-0.7.6.5-bgm';
const ASSETS=['./','./index.html','./styles.css','./dist/game.js','./manifest.webmanifest','./assets/cover.png','./assets/icon-192.png','./assets/icon-512.png','./assets/audio/mosu_kushiyaki_shop.mp3'];
